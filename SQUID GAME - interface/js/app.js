...
function updateinnerHTML(elemtHTML, txt){
...
function handleDislay(elemtHTML, display){
...
//#################################################//
//                                                 //
//PERMET DE MARQUE D'UNE CROIX ROUGE UN ENNEMI MORT//
//                                                 //
//#################################################//
...
//################################################################//
//                                                                //
//PERMET DE CAPTER L'EVENEMENT CLICK SUR LES BOUTONS PAIRE/IMPAIRE//
//                                                                //
//################################################################//
...
for(let i = 0; i < LIST_BLOCK_HTML.length; i++) {
    LIST_BLOCK_HTML[i].addEventListener("click", function(){
        ...
        // je veux récup la deuxième classe du block
        let listClass = this.classList;
        let secondClass = listClass[1];

        // si click sur élément block qui a une classe qui commence par l => selectLevel
        // si click sur élément block qui a une classe qui commence par h => selectHero
        // si click sur élément block qui a une classe qui commence par e => selectEncounter

        if(secondClass.startsWith("l")){
            selectLevels();
        } else if(secondClass.startsWith("h")){
